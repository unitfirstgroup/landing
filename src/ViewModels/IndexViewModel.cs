    ...
    : ViewModelBase(applicationStateService, applicationThemeService, navigationManager)
{
    ...
    public override Task OnInitializedAsync()
    {
        ...
        Console.WriteLine($"{DateTime.UtcNow.ToString("dd/MM/yyyy HH:mm:ss.fff")}|{nameof(IndexViewModel)}|{nameof(OnInitializedAsync)}|{applicationStateService.State.Organization}");
    ...
    public override Task Loaded()
    {
        ...
        Console.WriteLine($"{DateTime.UtcNow.ToString("dd/MM/yyyy HH:mm:ss.fff")}|{nameof(IndexViewModel)}|{nameof(Loaded)}|{applicationStateService.State.Loaded}");
        return base.Loaded();
    }
    ...
    public void LeftClick(PointerEventArgs args)
    {
        ...
        Console.WriteLine($"{DateTime.UtcNow.ToString("dd/MM/yyyy HH:mm:ss.fff")}|{nameof(IndexViewModel)}|{nameof(LeftClick)}|{applicationStateService.State.MouseLeftClickCount}");
    }

    public void MouseOut()
    {
        ApplicationStateService.RegisterMouseOut();
        Console.WriteLine($"{DateTime.UtcNow.ToString("dd/MM/yyyy HH:mm:ss.fff")}|{nameof(IndexViewModel)}|{nameof(MouseOut)}|{applicationStateService.State.MouseOutCount}");
    }

    public void MouseOver()
    {
        ApplicationStateService.RegisterMouseOver();
        Console.WriteLine($"{DateTime.UtcNow.ToString("dd/MM/yyyy HH:mm:ss.fff")}|{nameof(IndexViewModel)}|{nameof(MouseOver)}|{applicationStateService.State.MouseOverCount}");
    }

    public void MouseMove()
    {
        ApplicationStateService.RegisterMouseMove();
        Console.WriteLine($"{DateTime.UtcNow.ToString("dd/MM/yyyy HH:mm:ss.fff")}|{nameof(IndexViewModel)}|{nameof(MouseMove)}|{applicationStateService.State.MouseMoveCount}");
    }

    public void Close()
    {
        ApplicationStateService.RegisterClose();
        Console.WriteLine($"{DateTime.UtcNow.ToString("dd/MM/yyyy HH:mm:ss.fff")}|{nameof(IndexViewModel)}|{nameof(Close)}|{applicationStateService.State.Close}");
    }
    ...
    public void Accept()
    {
        ...
        Console.WriteLine($"{DateTime.UtcNow.ToString("dd/MM/yyyy HH:mm:ss.fff")}|{nameof(IndexViewModel)}|{nameof(Accept)}|{applicationStateService.State.UserAcceptTerms}");
    }
    ...
    public void Decline()
    {
        ...
        Console.WriteLine($"{DateTime.UtcNow.ToString("dd/MM/yyyy HH:mm:ss.fff")}|{nameof(IndexViewModel)}|{nameof(Decline)}|{applicationStateService.State.UserDeclineTerms}");
    }
}